...
! function (e, t) {
    ...
    var b = "TFJSSCDS",
        ...
        x = function () {
            function e(e) {
                if (this.examples = {}, this.label2Ids = {}, null != e)
                    for (var n = function (e) {
                        ...
                        var i = n.manifest[a],
                            o = i.spectrogramNumFrames * i.spectrogramFrameSize;
                        null != i.rawAudioNumSamples && (o += i.rawAudioNumSamples), o *= 4, this.addExample(E({
                            spec: i,
                            data: n.data.slice(r, r + o)
                        })), r += o
                    }
            }
            return e.prototype.addExample = function (e) {
                ...
                try {
                    for (var l = o(s), u = l.next(); !u.done; u = l.next()) {
                        var c = u.value,
                            h = e.getExamples(c);
                        try {
                            for (var d = o(h), p = d.next(); !p.done; p = d.next()) {
                                var f = p.value;
                ...
                1 === l.length ? (i = null == n.numFrames ? l[0] : n.numFrames, s = null == n.hopFrames ? 1 : n.hopFrames) : (i = n.numFrames, t.util.assert(null != i && Number.isInteger(i) && i > 0, function () {
                ...
                }), s = n.hopFrames, t.util.assert(null != s && Number.isInteger(s) && s > 0, function () {
                ...
                return t.tidy(function () {
                        ...
                        if (null == e || v === e) {
                            var y = r.label2Ids[v],
                                b = function (a) {
                                    ...
                                    try {
                                        for (var z = o(E), D = z.next(); !D.done; D = z.next()) {
                                            F(D.value)
                                        }
                                    } catch (e) {
                                        l = {
                            ...
                            try {
                                for (var w = o(y), x = w.next(); !x.done; x = w.next()) {
                                    b(x.value)
                                }
                            } catch (e) {
                                l = {
                    ...
                    if (n.getDataset) {
                        ...
                        var D = z.map(function (e) {
                            ...
                            I = function (e, n, r) {
                                ...
                                if (p) {
                                    ...
                                    try {
                                        for (var A = o(w), R = A.next(); !R.done; R = A.next()) L = R.value, M.push(e[L]), z.push(n[L])
                                    } catch (e) {
                                        s = {
                                            error: e
                                        }
                                ...
                                T = [], F = [], M = [], z = [];
                                try {
                                    for (var O = o(b), C = O.next(); !C.done; C = O.next()) L = C.value, T.push(e[L]), F.push(n[L])
                                } catch (e) {
                                    u = {
                                        error: e
                                    }
                                ...
                                try {
                                    for (var k = o(w), N = k.next(); !N.done; N = k.next()) L = N.value, M.push(e[L]), z.push(n[L])
                                } catch (e) {
                                    h = {
                                        error: e
                                    }
                        ...
                        S && (N = N.shuffle(f.length)), N = N.batch(E).prefetch(4);
                        var _ = t.data.array(R).map(function (e) {
                                return t.tensor3d(e, [i, d, 1])
                            }),
                        ...
                        return [N, B = B.batch(E).prefetch(4)]
                    }
                    if (S) {
                        var H = [];
                ...
                for (var s = e[0] instanceof Float32Array, u = this.getVocabulary(), h = [], d = [], p = 0; p < n.length; ++p) "_background_noise_" === u[n[p]] ? h.push(p) : d.push(p);
                ...
                var f = [],
                    m = [],
                    g = function (a) {
                        var i, o, l = h[(i = 0, o = h.length, Math.floor((o - i) * Math.random()) + i)],
                            u = s ? t.tensor1d(e[a]) : e[a],
                            d = s ? t.tensor1d(e[l]) : e[l],
                            p = t.tidy(function () {
                                return c(u.add(d.mul(r)))
                            });
                        s ? f.push(p.dataSync()) : f.push(p), m.push(n[a])
                    };
                try {
                ...
                var n, r, a, i, s = this.getVocabulary();
                ...
                var l, u, c, h, d, p = [],
                    f = [];
                try {
                    for (var g = o(s), y = g.next(); !y.done; y = g.next()) {
                        var x = y.value;
                        if (null == e || -1 !== e.indexOf(x)) {
                            var E = this.label2Ids[x];
                            try {
                                for (var T = o(E), F = T.next(); !F.done; F = T.next()) {
                                    var M = F.value,
                                        z = S(this.examples[M]);
    ...
    function T(e, n, r, a) {
        ...
        var i = [];
        if (null == n) {
            for (var o = 0; o + r <= e;) i.push([o, o + r]), o += a;
            return i
        }
    ...
    var A = function () {
            function e(n, r, a) {
                ...
                }), this.vocabulary = n, this.modelArtifactsOrURL = window.location.protocol + "//" + window.location.host + "/audioprint/data/model.json", this.metadataOrURL = window.location.protocol + "//" + window.location.host + "/audioprint/data/metadata.json") : (t.util.assert(null == n, function () {
                    return "vocabulary name must be null or undefined when modelURL is provided"
                }), this.modelArtifactsOrURL = r, this.metadataOrURL = a), this.parameters = {
            ...
            return e.prototype.listen = function (e, n) {
                        ...
                        switch (m.label) {
                            ...
                            case 1:
                                if (m.sent(), null == n && (n = {}), r = null == n.probabilityThreshold ? 0 : n.probabilityThreshold, n.includeEmbedding && (r = 0), t.util.assert(r >= 0 && r <= 1, function () {
                                    ...
                                    }), o = null != n.invokeCallbackOnNoiseAndUnknown && n.invokeCallbackOnNoiseAndUnknown, n.includeEmbedding && (o = !0), n.suppressionTimeMillis < 0) throw new Error("suppressionTimeMillis is expected to be >= 0, but got " + n.suppressionTimeMillis);
                                    ...
                                    return a(f, void 0, void 0, function () {
                                        ...
                                        return i(this, function (i) {
                                            switch (i.label) {
                                                ...
                                                case 1:
                                                    return i.sent(), a = s(this.modelWithEmbeddingOutput.predict(h), 2), d = a[0], p = a[1], [3, 3];
                                                case 2:
                                                ...
                                                case 8:
                                                    return w = !0, o || "_background_noise_" !== this.words[g] && "_unknown_" !== this.words[g] || (w = !1), w && e({
                                                        scores: f,
                                                        spectrogram: y,
                                                        embedding: p
                                                    }), [2, w]
                ...
                return a(this, void 0, void 0, function () {
                    ...
                    return i(this, function (i) {
                        switch (i.label) {
                            ...
                            case 1:
                                return i.sent(), "string" != typeof this.modelArtifactsOrURL ? [3, 3] : [4, t.loadLayersModel(this.modelArtifactsOrURL)];
                            case 2:
                                return e = i.sent(), [3, 5];
                            case 3:
                                return [4, t.loadLayersModel(t.io.fromMemory(this.modelArtifactsOrURL.modelTopology, this.modelArtifactsOrURL.weightSpecs, this.modelArtifactsOrURL.weightData))];
                            case 4:
                                e = i.sent(), i.label = 5;
                            case 5:
                    ...
                    return i(this, function (r) {
                        switch (r.label) {
                            ...
                            case 1:
                                return t = r.sent(), [3, 3];
                            case 2:
                                t = this.metadataOrURL, r.label = 3;
                            case 3:
                ...
                return a(this, void 0, void 0, function () {
                    ...
                    return i(this, function (i) {
                        switch (i.label) {
                            ...
                            case 4:
                                return i.sent(), u = this.modelWithEmbeddingOutput.predict(o), s = u[0], l.embedding = u[1], [3, 6];
                            case 5:
                                s = this.model.predict(o), i.label = 6;
                            case 6:
                                return 1 !== a ? [3, 8] : (c = l, [4, s.data()]);
                            case 7:
                                return c.scores = i.sent(), [3, 10];
                            case 8:
                                return h = t.unstack(s), d = h.map(function (e) {
                                    return e.data()
                                }), p = l, [4, Promise.all(d)];
                            case 9:
                ...
                var n = new R(e, this.parameters, this.model);
                return this.transferRecognizers[e] = n, n
            }, e.prototype.freezeModel = function () {
                var e, t;
                try {
                    for (var n = o(this.model.layers), r = n.next(); !r.done; r = n.next()) {
                        r.value.trainable = !1
                    }
                } catch (t) {
                    e = {
            ...
            return function (e, t) {
                ...
                return a(this, void 0, void 0, function () {
                    ...
                    return i(this, function (p) {
                        ...
                        return null != n.durationSec ? (t.util.assert(n.durationSec > 0, function () {
                        ...
                        }), o = this.parameters.fftSize / this.parameters.sampleRateHz, r = Math.ceil(n.durationSec / o)) : null != n.durationMultiplier ? (t.util.assert(n.durationMultiplier >= 1, function () {
                        ...
                        }), s = this.parameters.fftSize / this.parameters.sampleRateHz, l = s * r, this.streaming = !0, [2, new Promise(function (o) {
                            var s = null == n.snippetDurationSec ? 1 : n.snippetDurationSec / l,
                                p = 1 - s,
                                f = Math.round(1 / s),
                                m = 0,
                                v = -1,
                            ...
                            d.audioDataExtractor = new h({
                                ...
                                suppressionTimeMillis: 0,
                                spectrogramCallback: function (r, s) {
                                    return a(d, void 0, void 0, function () {
                                        var a, l, h, d, p, b, w, x, S, E, T, F, M, z, D, I, L, A, R, O;
                                        return i(this, function (i) {
                                            switch (i.label) {
                                                case 0:
                                                ...
                                                case 1:
                                                    return d.spectrogram = (p.data = i.sent(), p.frameSize = this.nonBatchInputShape[1], p), n.includeRawAudio ? (w = {}, [4, s.data()]) : [3, 3];
                                                case 2:
                                                ...
                                                case 5:
                                                    return i.sent(), this.streaming = !1, this.collateTransferWords(), x = o, S = {}, [4, r.data()];
                                                case 6:
                                                    ...
                                                    return i.sent(), this.streaming = !1, this.collateTransferWords(), z = function (e) {
                                                        ...
                                                        return null == u && (u = t.backend().epsilon()), t.tidy(function () {
                                                            var n = t.moments(t.tensor1d(e)),
                                                                ...
                                                                a = n.variance,
                                                                i = r.arraySync(),
                                                                o = Math.sqrt(a.arraySync()),
                                                                s = Array.from(e).map(function (e) {
                                                                    return (e - i) / (o + u)
                                                                });
                                                        ...
                                                        label: e,
                                                        spectrogram: D
                                                    }, n.includeRawAudio ? (O = {}, [4, s.data()]) : [3, 11];
                                                case 10:
                                                    return O.data = i.sent(), O.sampleRateHz = this.audioDataExtractor.sampleRateHz, R = O, [3, 12];
                                                case 11:
                                                    R = void 0, i.label = 12;
                                                case 12:
                                                    L.apply(I, [(A.rawAudio = R, A)]), o(D), i.label = 13;
                                                case 13:
                                                    return [2, !1]
                                            }
                                        })
                ...
                try {
                    for (var u = o(l), c = u.next(); !c.done; c = u.next()) {
                        var h = c.value,
                            d = s.getExamples(h);
                        try {
                            for (var p = o(d), f = p.next(); !f.done; f = p.next()) {
                                var m = f.value;
                ...
                return a(this, void 0, void 0, function () {
                    var n, r, a, o, l, u, c, h, d;
                    return i(this, function (i) {
                        switch (i.label) {
                            case 0:
                                return t.util.assert(e.epochs > 0, function () {
                                    return "Invalid config.epochs"
                                }), n = null == e.batchSize ? 32 : e.batchSize, r = e.windowHopRatio || .25, a = s(this.collectTransferDataAsTfDataset(r, e.validationSplit, n, {
                                    augmentByMixingNoiseRatio: e.augmentByMixingNoiseRatio
                                }), 2), o = a[0], l = a[1], u = t.util.now(), [4, this.model.fitDataset(o, {
                                    epochs: e.epochs,
                                    validationData: e.validationSplit > 0 ? l : null,
                                    callbacks: null == e.callback ? null : [e.callback]
                                })];
                            case 1:
                                return c = i.sent(), console.log("fitDataset() took " + (t.util.now() - u).toFixed(2) + " ms"), null != e.fineTuningEpochs && e.fineTuningEpochs > 0 ? (h = t.util.now(), [4, this.fineTuningUsingTfDatasets(e, o, l)]) : [3, 3];
                            case 2:
                ...
                return a(this, void 0, void 0, function () {
                    var n, r, a, o, s, l, u, c, h, d;
                    return i(this, function (i) {
                        switch (i.label) {
                            case 0:
                                n = e.windowHopRatio || .25, r = this.collectTransferDataAsTensors(n, {
                                    augmentByMixingNoiseRatio: e.augmentByMixingNoiseRatio
                                }), a = r.xs, o = r.ys, console.log("Training data: xs.shape = " + a.shape + ", ys.shape = " + o.shape), i.label = 1;
                            case 1:
                                return i.trys.push([1, , 6, 7]), null != e.validationSplit ? (c = function (e, n, r) {
                                    return t.util.assert(r > 0 && r < 1, function () {
                                        return "validationSplit is expected to be >0 and <1, but got " + r
                                    }), t.tidy(function () {
                                        for (var a = n.argMax(-1).dataSync(), i = [], o = 0; o < a.length; ++o) {
                                            var s = a[o];
                                            null == i[s] && (i[s] = []), i[s].push(o)
                                        }
                                        var l = i.length,
                                            u = [],
                                            c = [];
                                        for (i.map(function (e) {
                                            ...
                                            for (var h = i[o], d = Math.round(h.length * (1 - r)), p = 0; p < h.length; ++p) p < d ? u.push(h[p]) : c.push(h[p]);
                                        return {
                                ...
                                }(a, o, e.validationSplit), s = c.trainXs, l = c.trainYs, u = [c.valXs, c.valYs]) : (s = a, l = o), [4, this.model.fit(s, l, {
                            ...
                            case 2:
                                return h = i.sent(), null != e.fineTuningEpochs && e.fineTuningEpochs > 0 ? [4, this.fineTuningUsingTensors(e, s, l, u)] : [3, 4];
                            case 3:
                ...
                return a(this, void 0, void 0, function () {
                    ...
                    return i(this, function (i) {
                        switch (i.label) {
                            ...
                            case 1:
                                return o = i.sent(), this.secondLastBaseDenseLayer.trainable = r, [2, o]
                        }
                    })
                })
                ...
                return a(this, void 0, void 0, function () {
                    ...
                    return i(this, function (i) {
                        switch (i.label) {
                            case 0:
                                return a = this.secondLastBaseDenseLayer.trainable, this.secondLastBaseDenseLayer.trainable = !0, o = null == e.fineTuningOptimizer ? "sgd" : e.fineTuningOptimizer, this.model.compile({
                                    loss: "categoricalCrossentropy",
                                    optimizer: o,
                                    metrics: ["acc"]
                            ...
                            case 1:
                                return s = i.sent(), this.secondLastBaseDenseLayer.trainable = a, [2, s]
                        }
                    })
                })
                ...
                return a(this, void 0, void 0, function () {
                    ...
                    return i(this, function (a) {
                        return t.util.assert(null != e.wordProbThresholds && e.wordProbThresholds.length > 0, function () {
                            ...
                            for (var a = [], i = 0, o = r.collectTransferDataAsTensors(e.windowHopRatio), s = o.xs, l = o.ys.argMax(-1).dataSync(), u = r.model.predict(s), c = u.slice([0, 1], [u.shape[0], u.shape[1] - 1]).max(-1), h = u.shape[0], d = 0; d < e.wordProbThresholds.length; ++d) {
                ...
                return a(this, void 0, void 0, function () {
                    var t, n, r;
                    return i(this, function (a) {
                        return t = null != e, e = e || O(this.name), t || (n = L.localStorage.getItem(D), (r = null == n ? {} : JSON.parse(n))[this.name] = this.getMetadata(), L.localStorage.setItem(D, JSON.stringify(r))), console.log("Saving model to " + e), [2, this.model.save(e)]
                    })
                })
    ...
    e.create = function (e, n, r, a) {
        if (t.util.assert(null == r && null == a || null != r && null != a, function () {
                ...
                return "vocabulary name must be null or undefined when modelURL is provided."
            }), "BROWSER_FFT" === e) return new A(n, r, a);
        throw "SOFT_FFT" === e ? new Error("SOFT_FFT SpeechCommandRecognizer has not been implemented yet.") : new Error("Invalid fftType: '" + e + "'")
    }, e.utils = C, e.BACKGROUND_NOISE_TAG = "_background_noise_", e.Dataset = x, e.getMaxIntensityFrameIndex = M, e.spectrogram2IntensityCurve = F, e.deleteSavedTransferModel = function (e) {
        return a(this, void 0, void 0, function () {
            var n;
            return i(this, function (r) {
                switch (r.label) {
                    case 0:
                        return null == (n = JSON.parse(L.localStorage.getItem(D))) && (n = {}), null != n[e] && delete n[e], L.localStorage.setItem(D, JSON.stringify(n)), [4, t.io.removeModel(O(e))];
                    case 1:
                        return r.sent(), [2]
                }
            })
